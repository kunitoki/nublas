...
__all__ = [ "COUNTRIES", "EURO_VAT_COUNTRY_CODES", "CountryField" ]
...
#==============================================================================
# euro VAT country codes from http://www1.agenziaentrate.it/servizi/vies/vies.htm?p=&s=AT
EURO_VAT_COUNTRY_CODES = {
    'AT': ('AT', _('Austria')),
    'BE': ('BE', _('Belgium')),
    'BG': ('BG', _('Bulgaria')),
    'CY': ('CY', _('Cyprus')),
